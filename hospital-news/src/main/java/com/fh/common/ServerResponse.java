...
public class ServerResponse {
    ...
    public static ServerResponse code_error(ResponseEnum responseEnum){
        return new ServerResponse(responseEnum.getCode(),responseEnum.getMsg());
    }
    public static ServerResponse errors(ResponseEnum responseEnum, Object o){
        return new ServerResponse(responseEnum.getCode(),responseEnum.getMsg(),o);
    }
   /* public static ServerResponse  code_error(){
        return new ServerResponse(ResponseEnum.CODE_ERROR.getCode(),ResponseEnum.ERROR.getMsg());
    }*/
    ...
    public static ServerResponse error(ResponseEnum data){
        return new ServerResponse(data.getCode(),data.getMsg());
    }
